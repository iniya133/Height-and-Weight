...
height_second_std_deviation_start, height_second_std_deviation_end = height_mean-(height_std_deviation * 2), height_mean+(height_std_deviation * 2)
height_third_std_deviation_start, height_third_std_deviation_end = height_mean-(height_std_deviation * 3), height_mean+(height_std_deviation * 3)
...
weight_second_std_deviation_start, weight_second_std_deviation_end = weight_mean-(weight_std_deviation * 2), weight_mean+(weight_std_deviation * 2)
weight_third_std_deviation_start, weight_third_std_deviation_end = weight_mean-(weight_std_deviation * 3), weight_mean+(weight_std_deviation * 3)
